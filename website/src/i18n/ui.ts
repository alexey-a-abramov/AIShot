...
export const ui: Record<Lang, Content> = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Capture, annotate, and recognize — then let local AI agents drive the same capabilities over an embedded MCP server. Nothing leaves your Mac.',
    ...
    features: [
      ...
      { title: 'Screen recording', desc: 'Record a display to H.264 video, straight to your save folder.' },
    ...
    agents: {
      ...
      gated: 'Privileged input tools require explicit confirmation and are bound to loopback only.',
    },
    how: {
      title: 'How it works',
      steps: [
        ...
        { title: 'Connect agents', desc: 'Point your MCP client at the bundled server and let agents work.' },
      ],
    },
    privacy: {
      ...
      points: [
        ...
        'The MCP server binds to loopback with a per-launch token.',
  ...
  fr: {
    ...
    agents: {
      ...
      gated: 'Les outils de saisie privilégiés exigent une confirmation explicite et restent limités à la boucle locale.',
    },
    how: {
      ...
      steps: [
        ...
        { title: 'Connecter les agents', desc: 'Pointez votre client MCP vers le serveur intégré et laissez les agents travailler.' },
      ],
    },
    privacy: {
      ...
      points: [
        ...
        'Le serveur MCP écoute uniquement en boucle locale avec un jeton par session.',
  ...
  es: {
    ...
    agents: {
      ...
      gated: 'Las herramientas de entrada privilegiadas exigen confirmación explícita y se limitan a loopback.',
    },
    how: {
      title: 'Cómo funciona',
      steps: [
    ...
    privacy: {
      ...
      points: [
        ...
        'El servidor MCP escucha solo en loopback con un token por sesión.',
